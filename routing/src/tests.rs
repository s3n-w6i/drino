...
macro_rules! earliest_arrival_tests {
    ($t: ty) => {
        ...
        use crate::routing::algorithm::{ EarliestArrival, Journey, Leg, Single, SingleEarliestArrival};
        use routing::::CrowFlyTransferProvider;
        use crate::types::{LineId, SeqNum, StopId, TripId};
        use crate::util::speed::MAX_WALKING_SPEED;
        ...
        async fn test_query_earliest_4() {
            ...
            let stop3_coord = Coord { x:  0.0, y:  0.0 };
            let stop4_coord = Coord { x:  0.001, y:  0.01 };
            ...
            assert_eq!(
                ...
                Journey { legs: vec![
                    ...
                    Leg::Transfer {
                        ...
                        duration: MAX_WALKING_SPEED.time_to_travel_distance(Point::from(stop3_coord).haversine_distance(&Point::from(stop4_coord))),
                    },
                ]}
            );
